...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedDevice) DeepCopyInto(out *ManagedDevice) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedDevice.
func (in *ManagedDevice) DeepCopy() *ManagedDevice {
	if in == nil {
		return nil
	}
	out := new(ManagedDevice)
	in.DeepCopyInto(out)
	return out
}
